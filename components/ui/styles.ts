...
export const sectionEyebrowClassName =
  "inline-flex min-h-8 items-center gap-2 rounded-full border border-[color:var(--primary-border)] bg-[color:var(--primary-soft)] px-3 text-xs font-semibold text-[color:var(--primary)] shadow-sm shadow-indigo-950/5 backdrop-blur";
...
export const primaryButtonClassName =
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl bg-[color:var(--primary)] px-5 py-2.5 text-sm font-semibold text-[color:var(--primary-foreground)] shadow-lg shadow-indigo-950/15 transition-all duration-200 hover:-translate-y-0.5 hover:opacity-95 hover:shadow-xl hover:shadow-indigo-950/20 focus:outline-none focus:ring-4 focus:ring-indigo-500/20 disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:translate-y-0";
...
export const iconButtonClassName =
  "inline-flex min-h-11 min-w-11 items-center justify-center rounded-xl border border-[color:var(--border)] bg-[color:var(--surface)] text-[color:var(--muted-foreground)] transition-all duration-200 hover:-translate-y-0.5 hover:border-[color:var(--primary-border)] hover:bg-[color:var(--surface-muted)] hover:text-[color:var(--primary)] focus:outline-none focus:ring-4 focus:ring-indigo-500/10";

export const fieldClassName =
  "min-h-12 w-full rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] px-4 py-3 text-sm text-[color:var(--foreground)] shadow-sm outline-none transition placeholder:text-[color:var(--muted-foreground)] focus:border-indigo-500/30 focus:ring-4 focus:ring-indigo-500/10";

export const textareaClassName =
  "min-h-44 w-full rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] px-4 py-3 text-sm leading-6 text-[color:var(--foreground)] shadow-sm outline-none transition placeholder:text-[color:var(--muted-foreground)] focus:border-indigo-500/30 focus:ring-4 focus:ring-indigo-500/10";

export const selectClassName =
  "min-h-12 w-full appearance-none rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] px-4 py-3 text-sm font-medium text-[color:var(--foreground)] shadow-sm outline-none transition focus:border-indigo-500/30 focus:ring-4 focus:ring-indigo-500/10";
...
export const cardShellInteractiveClassName =
  "rounded-[1.75rem] border border-[color:var(--border)] bg-[color:var(--surface-elevated)] text-[color:var(--foreground)] shadow-[0_20px_60px_-42px_rgba(15,23,42,0.16)] backdrop-blur-xl transition-all duration-200 hover:-translate-y-1 hover:border-[color:var(--primary-border)] hover:shadow-[0_28px_80px_-44px_rgba(79,70,229,0.18)]";
...
export const mobileBottomNavItemActiveClassName =
  "bg-[color:var(--primary-soft)] text-[color:var(--primary)] shadow-[0_10px_24px_-14px_rgba(79,70,229,0.45)]";
...
export const mobileBottomNavIndicatorClassName =
  "absolute inset-x-6 bottom-1 h-0.5 rounded-full bg-[color:var(--primary)] transition-all duration-200";
