...
export const mobileBottomNavItemClassName =
  "group relative flex min-h-14 flex-col items-center justify-center gap-1 overflow-hidden rounded-2xl px-4 py-3 text-sm font-medium transition-all duration-150 ease-out focus:outline-none focus:ring-4 focus:ring-slate-500/20 active:scale-[0.98]";
